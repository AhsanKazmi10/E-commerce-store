...
export default function WovenmonogramsPage() {
  ...
  const fetchProducts = async () => {
    try {
      const response = await fetch("/api/products?category=woven-monograms");
    ...
    <div>
      ...
      <section className="relative h-[60vh] bg-gradient-to-r from-purple-900 to-indigo-900">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white">
          <h1 className="text-5xl md:text-7xl font-bold mb-4">Woven Monograms</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">Discover our premium woven monograms collection</p>
        </div>
